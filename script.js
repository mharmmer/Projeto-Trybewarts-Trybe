...
const housesStyle = () => {
  if (houses.value === 'Gitnória') {
    ...
    footer.style.boxShadow = 'rgba(223 9 9 / 20%) 0px 4px 3px 6px';
    ...
    footer.style.boxShadow = 'rgba(227 187 12 / 20%) 0px 4px 3px 6px';
    ...
    footer.style.boxShadow = 'rgba(0 10 144 / 20%) 0px 4px 3px 6px';
    ...
    footer.style.boxShadow = 'rgba(13 98 23 / 20%) 0px 4px 3px 6px';
    ...
    footer.style.boxShadow = 'rgb(255, 255, 255, 0.2) 0px 4px 3px 6px';
